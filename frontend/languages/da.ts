export const da = {
  ...
  claim: {
    title: "Tilmeld dig",
    subtitle: "Skriv dit navn og nummer for eksklusive tilbud",
    nameLabel: "Dit navn",
    namePlaceholder: "Skriv dit navn",
    phoneLabel: "Telefonnummer",
    phonePlaceholder: "Skriv dit nummer",
    birthdayLabel: "Fødselsdag",
    birthdayHint: "Vi sender dig en fødselsdagsrabat!",
    cafeCodeLabel: "Kode fra caféen",
    cafeCodePlaceholder: "Skriv koden fra caféen",
    countryCodeLabel: "Landekode",
    countryCodePlaceholder: "Vælg landekode...",
    countryCodeSearchPlaceholder: "Søg...",
    countryCodeNotFound: "Ingen lande fundet.",
    privacyText:
      "Telefonnummeret du oplyser, bruges til at bekræfte dig og til at sende eksklusive tilbud. Vi respekterer dit privatliv og deler ikke dine oplysninger med tredjeparter.",
    submit: "Tilmeld mig",
    submitting: "Sender...",
    invalidPhone: "Indtast et gyldigt telefonnummer.",
    failed: "Kunne ikke tilmelde. Prøv igen.",
    successTitle: "Tak! Du er tilmeldt.",
    successSubtitle: "Du får eksklusive tilbud på SMS.",
    successButton: "Tilmeld en anden",
  },
  faq: {
    title: "— FAQ",
    questions: [
