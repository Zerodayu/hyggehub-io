...
export default function ShopCardSection() {
  ...
  const sendSmsMutation = useMutation({
    mutationFn: ({
      ...
      const formattedMessage = formatMessage("default", templateData);
  ...
  const handleSendMessageToSubscribers = (
    messageText: string,
    messageId: string,
    title: string,
    expiresAt: string | null,
  ...
  const handleInitEditMessage = (message: {
    id: string;
    value: string;
    title: string;
    expiresAt: string | null;
  ...
  const handleEditExpiresAtChange = (
    date: string | ((prevDate: string) => string),
  ) => {
                    ...
                    <CardFooter className="text-muted-foreground justify-between">
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                permanently delete this message and remove it
                                from the system.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                      ...
                      <div className="flex gap-2">
                        <Dialog>
                          ...
                          <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Update your shop message. Click save when
                                you&apos;re done.
                              </DialogDescription>
                            </DialogHeader>
                        ...
                        <Button
                          className="font-mono"
                          onClick={() =>
                            handleSendMessageToSubscribers(
                              message.value,
                              message.id,
                              message.title,
                              message.expiresAt,
